...
[CS2,CH2]=m_contour(lon,lat,double(eta)',[-2300 -2300],'edgecolor',[0 32 96]./255);
Contour2300 = CS2(:,740:926);
[CS3,CH3]=m_contour(lon,lat,double(eta)',[-750 -750],'edgecolor',[0 32 96]./255);
Contour750 = CS3(:,909:1193);
[x,y]= m_ll2xy([-76 -76 -75 -72 -70 -68 -64],[72.4 71 70 69 68 67 66.5]);
Contour750 = cat(2,[x;y],Contour750,[x(1);y(1)]);
clf
