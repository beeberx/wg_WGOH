...
set(ax1,'xcolor',[.2 .2 .2],'ycolor',[.2 .2 .2],'fontsize',14);
...
set(ax1,'xaxislocation','top','xtick',[Xdata(1:5:end)],'fontsize',14)
...
set(tx,'position',[0.025 0.03 0.95 0.05])
% caxis([-3.5 3.5])
%h = colorbar(ax1,'eastoutside','fontsize',14,'fontname','arial');
%htick = [-3.5:0.5:3.5];
