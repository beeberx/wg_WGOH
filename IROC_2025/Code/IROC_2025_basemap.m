...
[CS,CH]=contourf(lon,lat,double(eta)',[-10000:1000:1000 1000:100:0 250:250:3000],'edgecolor','none');
hold on
caxis([-10000 3000])
...
plot(rdata(:,1),rdata(:,2),'-','LineWidth',1,'color','r')%[.6 .6 .6]
end
...
set(gcf,'paperorientation','landscape','papertype','a4','paperpositionmode','auto',...
    'paperunits','centimeters','paperposition',[0.6 0.6 28.4 19.7])
print(gcf, '-dpng', '-r300', 'IROC_2025_RegionalBoundaries2b.png')  